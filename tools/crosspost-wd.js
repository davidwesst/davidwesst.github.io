...
// check for help flag
if(args.find(item => item === "--help")) {
    console.log(`
    --- crosspost-wd HELP ---
    A utility to crosspost a post from davidwesst.com to westerndevs.com using git.
    
    Usage: crosspost-wd.js <slug> <path (OPTIONAL)>
    Example: ./tools/crosspost-wd.js my-awesome-blog-post ./src/blog/my-awesome-blog-post
    `);
}
else {
    ...
    if(fs.existsSync(path.resolve(source_path)) === true) {
        ...
        console.error(`${source_path} was not found.`);
    }
}